    ...
    def run(self):
        ...
        while True:
            ...
            while True:
                ...
                # ── Destination verification (runs before general verify) ──────
                # Checks that the file landed exactly where DestinationTarget says.
                # Explicit: must match the exact path.
                # Alias / implicit: must be inside expected_directory.
                    ...
                    if dest_ok:
                        ...
                        self.logger.warning(
                            ...
                            extra={"tool_args": {
                                ...
                                "expected_path": str(dest_target.expected_path) if dest_target.expected_path else None,
