...
- Para equipos mas justos, tambien existe `LOCAL CODER [qwen2.5-coder-3b].bat`
...
- `INSTALL MODEL [qwen2.5-coder-3b].bat` descarga una variante mas ligera para comparar latencia
